...
window.particlesJS = function(tag_id, params){
  ...
  if(pJS_tag.getElementsByClassName(pJS_canvas_class)){
    var exist_canvas = pJS_tag.getElementsByClassName(pJS_canvas_class);
  }else{
    console.log("no hay particles-js-canvas-el");
  }

  //console.log(document.getElementById('particles-js').getElementsByClassName('particles-js-canvas-el'))
