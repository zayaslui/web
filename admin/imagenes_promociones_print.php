...
$layout = new TLayout("print", "OfficeCoral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["imagenes_promociones_print"] = $layout;
...
$layout = new TLayout("masterprint", "OfficeCoral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["promociones_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "imagenes_promociones" );
