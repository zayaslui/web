...
function GetTableURL($table = "")
{
	...
	if("sliders" == $table) 
		return "sliders";
	if("imagenes_promociones" == $table) 
		return "imagenes_promociones";
	if("destinos" == $table) 
		return "destinos";
	if("empresas" == $table) 
		return "empresas";
...
{	
	...
	if(!$shortTName)
		return false;
	if("promociones" == $shortTName) 
		return "promociones";
	if("monedas" == $shortTName) 
		return "monedas";
	if("detalles" == $shortTName) 
		return "detalles";
	if("sliders" == $shortTName) 
		return "sliders";
	if("imagenes_promociones" == $shortTName) 
		return "imagenes_promociones";
	if("destinos" == $shortTName) 
		return "destinos";
	...
	if("zonas" == $shortTName) 
		return "zonas";
	if("galerias" == $shortTName) 
		return "galerias";
	if("menu_servicios" == $shortTName) 
		return "menu_servicios";
}
