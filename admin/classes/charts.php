...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("promociones" == $this->chrt_array['tables'][0])
			return true;
		if("monedas" == $this->chrt_array['tables'][0])
			return true;
		if("detalles" == $this->chrt_array['tables'][0])
			return true;
		if("sliders" == $this->chrt_array['tables'][0])
			return true;
		if("imagenes_promociones" == $this->chrt_array['tables'][0])
			return true;
		if("destinos" == $this->chrt_array['tables'][0])
			return true;
		if("empresas" == $this->chrt_array['tables'][0])
			return true;
		if("usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("zonas" == $this->chrt_array['tables'][0])
			return true;
		if("galerias" == $this->chrt_array['tables'][0])
			return true;
		if("menu_servicios" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
