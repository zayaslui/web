...
require_once("include/promociones_variables.php");
...
$layout->blocks["top"][] = "master";
$page_layouts["detalles_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "promociones" );
